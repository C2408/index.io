...
<link rel="stylesheet" media="screen and (max-width:800px)" href="css/base_sp.css">
...
<div id="pagebody">
	...
	<!-- ヘッダ -->
	<div id="header">
	<h1><a href="index.html"><img src="img/do.ico" alt="ウェブサンプル株式会社"></a></h1>
	</div>
	...
	<!-- ヘッダ画像 -->
	<div id="img_index">
	<img src="img/t.jpg" alt="あしたをみつめるウェブサンプル株式会社">
	</div>
    <!-- <video src="video/1.mp4" poster="img/t.jpg" controls muted></video> -->
	<!-- サブメニュー（左カラム） -->
	<div id="submenu">
		<h2>新着情報</h2>
		<ul>
